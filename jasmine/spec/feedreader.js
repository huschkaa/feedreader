    ...
    describe('New Feed Selection', function() {
      ...
      let updatedFeed;
         ...
         */
         ...
         //beforeEach for the first async call
         beforeEach(function(done) {
             loadFeed(1, function() {
          ...
          //Ensures elements are defined, compares originalFeed and
          //UpdatedFeed to ensure they have changed.
           it('displays a change in the content', function() {
              expect(originalFeed).toBeDefined();
              updatedFeed = $('.feed').html();
              expect(updatedFeed).toBeDefined();
              expect(originalFeed).not.toEqual(updatedFeed);
           });
    });
}());
